...
const guideSteps: GuideStep[] = [
  ...
  { view: 'payroll', target: '[data-guide="payroll-filters"]', title: 'Payroll filters', description: 'Search finds an employee. Role and status buttons make the payroll list shorter and easier to check.', tip: 'These filters are safe. They do not change pay.' },
  { view: 'payroll', target: '[data-guide="payroll-hub"]', title: 'Payroll actions', description: 'Process Payslip starts a payroll record. View opens its summary. Confirm Paid marks payment as complete.', tip: 'Confirm Paid changes real data. Use it only after payment is complete.' },
