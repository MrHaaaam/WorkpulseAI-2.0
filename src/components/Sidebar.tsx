...
export type ViewKey = "overview" | "employees" | "payroll" | "biometric" | "analytics" | "settings" | "leave" | "admin";
    ...
    <div className="min-w-0">
      ...
      <div className="border-t border-slate-200 p-4">
        <div className="flex items-center gap-3 rounded-xl bg-slate-50 p-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-[#8642ED] to-[#8642ED] text-sm font-bold text-white">
            M
          </div>
