...
export function AdminOverviewView() {
  ...
  // Calculate live data totals for the admin metrics
  ...
  // Combined metrics tailored specifically for the Admin View
  const adminMetrics = [
    { label: "Total Registered Staff", value: totals.total.toString(), change: "+2", trend: "up", icon: Users, bgClass: "bg-[#8642ED]/10", iconColor: "text-[#8642ED]" },
    { label: "Active Workforce", value: totals.active.toString(), change: "+1", trend: "up", icon: UserCheck, bgClass: "bg-emerald-50", iconColor: "text-emerald-600" },
    { label: "Pending Payroll Sign-offs", value: pendingPayroll.length.toString(), change: "Action Req.", trend: "down", icon: Clock, bgClass: "bg-amber-50", iconColor: "text-amber-600" },
    { label: "Biometric Keys Active", value: "18", change: "+3", trend: "up", icon: Fingerprint, bgClass: "bg-violet-50", iconColor: "text-violet-600" },
  ];
  ...
  return (
    <div className="space-y-6">
            ...
            <Card key={m.label} className="animate-fade-in">
              <CardContent className="p-5">
                <div className="flex items-start justify-between">
                  <div className={`flex h-11 w-11 items-center justify-center rounded-xl ${m.bgClass} shadow-sm`}>
      ...
      {/* Middle Grid: Attention Widgets and Bar Graph Comparison */}
      ...
      {/* Global Recent Activities Logs Table */}
      <Card>
        <CardHeader>
